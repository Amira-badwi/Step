...
function CourseContent(props) {
  ...
  return (
    <div>
      {props.courseData.courseSections.map((section, index) => <CurriclemSection handleSectionEdit={handleSectionEdit} handleSectionDelete={handleSectionDelete} key={index} sectionNumber={index + 1} section={section} courseData={props.courseData} setCourseData={props.setCourseData} />)}
